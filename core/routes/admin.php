...
Route::prefix('drivers')->name('driver.')->group(function () {
    Route::get('/', [DriverController::class, 'index'])->name('driver');        // driver.index
    Route::get('create', [DriverController::class, 'create'])->name('create'); // driver.create
    Route::post('store', [DriverController::class, 'store'])->name('store');   // driver.store
    Route::get('edit/{id}', [DriverController::class, 'edit'])->name('edit');  // driver.edit
    Route::post('update/{id}', [DriverController::class, 'update'])->name('update'); // driver.update
    Route::post('delete/{id}', [DriverController::class, 'destroy'])->name('delete'); // driver.delete
});

Route::prefix('role')->name('role.')->group(function () {
    Route::get('/', [RoleController::class, 'index'])->name('index');        // role.index
    Route::get('create', [RoleController::class, 'create'])->name('create'); // role.create
    Route::post('store', [RoleController::class, 'store'])->name('store');   // role.store
...
Route::prefix('staff')->name('staff.')->group(function () {
    Route::get('/', [StaffController::class, 'index'])->name('index'); // ✅ now the route name is staff.index
