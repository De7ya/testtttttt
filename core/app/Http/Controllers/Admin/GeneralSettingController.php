...
class GeneralSettingController extends Controller
{
    ...
    public function generalUpdate(Request $request)
    {
        ...
        $notify[] = ['success', 'تم تحديث الإعدادات العامة بنجاح.'];
    ...
    public function systemConfigurationSubmit(Request $request)
    {
        ...
        $general->save();
        $notify[] = ['success', 'تم تحديث تهيئة النظام بنجاح.'];
        return back()->withNotify($notify);
    }
    ...
    public function logoIconUpdate(Request $request)
    {
        ...
        if ($request->hasFile('logo_dark')) {
            try {
                ...
                $notify[] = ['error', 'تعذر رفع الشعار الغامق '];
                return back()->withNotify($notify);
            }
        }
        ...
        if ($request->hasFile('favicon')) {
            try {
                ...
                $notify[] = ['error', 'تعذر رفع الشعار المفضل'];
                return back()->withNotify($notify);
            }
        }
        $notify[] = ['success', 'تم تحديث الشعار والأيقونة المفضلة (Favicon) بنجاح.'];
        return back()->withNotify($notify);
    }
    ...
    public function sitemapSubmit(Request $request){
        ...
        $notify[] = ['success','تم تحديث خريطة الموقع بنجاح.'];
        return back()->withNotify($notify);
    }
    ...
    public function robotSubmit(Request $request){
        ...
        $notify[] = ['success','تم تحديث ملف robots.txt بنجاح.'];
        return back()->withNotify($notify);
    }
    ...
    public function customCssSubmit(Request $request){
        ...
        $notify[] = ['success','تم تحديث ملف CSS بنجاح.'];
        return back()->withNotify($notify);
    }
    ...
    public function cookieSubmit(Request $request){
        ...
        $cookie->save();
        $notify[] = ['success','تم تحديث سياسة ملفات تعريف الارتباط (الكوكيز) بنجاح.'];
        return back()->withNotify($notify);
    }
    ...
    public function updateSocialiteCredentialStatus($key)
    {
        ...
        $notify[] = ['success', 'تم تغيير الحالة بنجاح.'];
        return back()->withNotify($notify);
    }
