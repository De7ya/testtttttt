...
class NotificationController extends Controller
{
    ...
    public function globalEmailUpdate(Request $request){
        ...
        $notify[] = ['success','تم تحديث نموذج البريد الإلكتروني العام بنجاح.'];
    ...
    public function globalPushUpdate(Request $request){
        ...
        $notify[] = ['success','تم تحديث نموذج إشعارات الدفع العام بنجاح.'];
        return back()->withNotify($notify);
    }
    ...
    public function templateUpdate(Request $request,$type,$id){
        ...
        $notify[] = ['success','تم تحديث نموذج الإشعارات بنجاح.'];
        return back()->withNotify($notify);
    }
    ...
    public function emailSettingUpdate(Request $request)
    {
        ...
        $general->save();
        $notify[] = ['success', 'تم تحديث إعدادات البريد الإلكتروني بنجاح.'];
        return back()->withNotify($notify);
    }
    ...
    public function emailTest(Request $request){
       ...
       if (gs('en')) {
           ...
           $notify[] = ['info', 'يرجى التفعيل من الإعدادات العامة.'];
           $notify[] = ['error', 'تم تعطيل إشعارات البريد الإلكتروني لديك.'];
           return back()->withNotify($notify);
       }
