    ...
    <div class="row mb-none-30">
      <div class="col-md-12 mb-30">
            <div class="card bl--5 border--primary">
                <div class="card-body">
                    <p class="text--primary">@lang('من هذه الصفحة، يمكنك إضافة/تحديث CSS لواجهة المستخدم. يتطلب تغيير محتوى هذه الصفحة معرفة برمجية.')</p>
                    <p class="text--warning">@lang('يرجى عدم تغيير/تعديل/إضافة أي شيء دون علمك به جيدًا. قد يتعطل الموقع بسبب أي خطأ ارتكبته.')</p>
                </div>
            </div>
        </div>
        <div class="col-lg-12">
