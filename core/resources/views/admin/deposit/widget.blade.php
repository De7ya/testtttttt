            ...
            <div class="widget-card bg--success">
                ...
                <div class="widget-card-left">
                    ...
                    <div class="widget-card-content">
                        ...
                        <p class="widget-card-title">@lang('إيداع ناجح')</p>
                    </div>
                </div>
            ...
            <div class="widget-card bg--warning">
                ...
                <div class="widget-card-left">
                    ...
                    <div class="widget-card-content">
                        ...
                        <p class="widget-card-title">@lang('إيداع معلق')</p>
                    </div>
                </div>
                <span class="widget-card-arrow">
                    <i class="las la-angle-right"></i>
            ...
            <div class="widget-card bg--danger">
                ...
                <div class="widget-card-left">
                    ...
                    <div class="widget-card-content">
                        ...
                        <p class="widget-card-title">@lang('إيداع مرفوض')</p>
                    </div>
                </div>
                <span class="widget-card-arrow">
                    <i class="las la-angle-right"></i>
            ...
            <div class="widget-card bg--dark">
                ...
                <div class="widget-card-left">
                    ...
                    <div class="widget-card-content">
                        ...
                        <p class="widget-card-title">@lang('الإيداع المبدئي')</p>
                    </div>
                </div>
                <span class="widget-card-arrow">
                    <i class="las la-angle-right"></i>
