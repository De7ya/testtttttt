                            ...
                            <div class="card">
                                <div class="card-body p-5 text-center">
                                    <div class="coaling-loader flex-column d-flex justify-content-center">
                                        ...
                                        <p class="mt-2">
                                            @lang("$viaText سيتم إرسالها مرة أخرى مع") <span class="coaling-time-count"></span>
                                            @lang('تأخير ثانٍ. تجنب إغلاق المتصفح أو تحديثه.')
                                        </p>
                                        <p class="text--primary">
                                            @lang(' ' . @$sessionData['الإجمالي المرسل'] . ' out of ' . @$sessionData['total_user'] . ' ' . $viaName . ' were successfully transmitted')
                                        </p>
                                    </div>
                                </div>
                            </div>
                                        ...
                                        <div class="col-xxl-2 col-xl-3 col-lg-4 col-md-3 col-sm-6">
                                            <div class="notification-via mb-4  @if ($viaName == 'email') active @endif " data-method="email">
                                                ...
                                                <div class="send-via-method">
                                                    ...
                                                    <h5>@lang('إرسال عبر البريد الإلكتروني')</h5>
                                                </div>
                                            </div>
                                        </div>
                                    @endif
                                        ...
                                        <div class="col-xxl-2 col-xl-3 col-lg-4 col-md-3 col-sm-6">
                                            <div class="notification-via mb-4 @if ($viaName == 'sms') active @endif " data-method="sms">
                                                ...
                                                <div class="send-via-method">
                                                    ...
                                                    <h5>@lang('إرسال عبر الرسائل القصيرة')</h5>
                                                </div>
                                            </div>
                                        </div>
                                    @endif
 ...
 --}}                                    @endif
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label>@lang('يتم إرسالها إلى') </label>
                                    ...
                                    <small class="text--info d-none userCountText"> <i class="las la-info-circle"></i> <strong
                                            class="userCount">0</strong> @lang('تم العثور على المستخدمين النشطين لإرسال الإشعار')</small>
                                </div>
                                <div class="input-append">
                                </div>
                            </div>
                            <div class="form-group col-md-12 subject-wrapper">
                                <label>@lang('الموضوع') <span class="text--danger">*</span> </label>
                                <input type="text" class="form-control" placeholder="@lang('الموضوع')" name="subject"
                                    ...
                                    <div class="col-md-4 start-from-col">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" name="start" value="{{ old('start', @$sessionData['start']) }}"
                                                type="number" placeholder="@lang('ابدأ من مُعرّف المستخدم')" required>
                                        </div>
                                    </div>
                                    <div class="col-md-4 per-batch-col">
                                        <div class="form-group">
                                            <label>@lang('لكل دفعة') </label>
                                            <div class="input-group">
                                                <input class="form-control" name="batch" value="{{ old('batch', @$sessionData['batch']) }}"
                                                    type="number" placeholder="@lang('كم عدد المستخدمين')" required>
                    ...
                    <div class="card-footer">
                        <button class="btn w-100 h-45 btn--primary me-2" type="submit">@lang('تأكيد')</button>
                    </div>
                </form>
            </div>
        </div>
        ...
        @if (!empty(@$sessionData) && @request()->email_sent && @request()->email_sent = 'yes')
            window.addEventListener('beforeunload', function(event) {
                if (!formSubmit) {
                    ...
                    event.returnValue = '';
                    var confirmationMessage = 'هل أنت متأكد أنك تريد مغادرة هذه الصفحة؟';
