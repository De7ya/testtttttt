            ...
            <div class="card">
                <form action="{{ route('admin.users.notification.single', $user->id) }}" class="notificationForm" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="form-group col-md-12 subject-wrapper">
                                ...
                                <input type="text" class="form-control" placeholder="@lang('الموضوع / العنوان')" name="subject">
                            </div>
                            <div class="form-group col-md-12 push-notification-file d-none">
                                <label>@lang('الصورة (اختياري)') </label>
                                <input type="file" class="form-control" accept=".png,.jpg,.jpeg" name="image">
                                <small class="mt-3 text-muted"> @lang('الملفات المدعومة'):<b>@lang('.png, .jpg, .jpeg')</b> </small>
                            </div>
                    ...
                    <div class="card-footer">
                        <button type="submit" class="btn w-100 h-45 btn--primary">@lang('تأكيد')</button>
                    </div>
                </form>
            </div>
        </div>
