  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="bugModalLabel">@lang('التقرير والطلب')</h5>
        ...
        <div class="modal-body">
          <div class="form-group">
            ...
            <select class="form-control select2" data-minimum-results-for-search="-1" name="type" required>
              <option value="bug" @selected(old('type') == 'bug')>@lang('الإبلاغ عن خطأ')</option>
              <option value="feature" @selected(old('type') == 'feature')>@lang('طلب ميزة')</option>
            </select>
          </div>
          <div class="form-group">
            <label>@lang('الرسالة')</label>
...
@push('breadcrumb-plugins')
    <button class="btn btn-sm btn-outline--warning" data-bs-toggle="modal" data-bs-target="#bugModal"><i class="las la-bug"></i> @lang('الإبلاغ عن خطأ')</button>
    <a href="https://viserlab.com/support" target="_blank" class="btn btn-sm btn-outline--success"><i class="las la-headset"></i> @lang('طلب الدعم')</a>
@endpush
