...
@section('panel')
    <div class="row mb-none-30">
        <div class="col-xl-12 col-lg-12 col-md-12 mb-30">
            <div class="card">
                <h5 class="card-header">@lang('معلومات عن الطريق') </h5>
                <div class="card-body">
                    <form action="{{ route('admin.trip.route.store') }}" method="POST">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label> @lang('تحديد السائق')</label>
                                    <select name="driver" class="select2" required>
                                        <option value="">@lang('حدد خيارًا')</option>
                                        @foreach ($stoppages as $item)
                                            <option value="{{ $item->id }}">{{ __($item->name) }}</option>
                                        @endforeach
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    <div class="custom-control custom-checkbox form-check-primary">
                                        ...
                                        <label class="custom-control-label" for="has-stoppage">@lang('لديه المزيد من التوقف')</label>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label> @lang('الوقت')</label>
                                    <input type="text" class="form-control" name="time" placeholder="@lang('أدخل الوقت التقريبي')" required>
                                    <small class="text--info text--small"><i class="fas fa-info-circle"></i> @lang('الحفاظ على مسافة بين القيمة والوحدة')</small>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label> @lang('المسافة')</label>
            ...
            $('#has-stoppage').on('click', function() {
                if (this.checked) {
                    var html = `<div class="row stoppages-row">
                                        ...
                                        <div class="form-group">
                                            <div class="input-group">
                                                ...
                                                <select class="select2-basic" name="stoppages[1]" required>
                                                    <option value="" selected>@lang('حدد التوقف')</option>
                                ...
                                <button type="button" class="btn btn-sm btn--success add-stoppage-btn mb-1"><i class="la la-plus"></i>@lang('التوقف التالي')</button> <br>
                                <span class="text--danger text--small"><i class="fas fa-exclamation-triangle"></i> @lang('تأكد من إضافة نقاط التوقف بشكل تسلسلي متبوعة بنقطة البداية')</span>`;
