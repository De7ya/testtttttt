                                            ...
                                            <form action="{{ route('admin.trip.ticket.price.update', $ticket->id) }}" class="update-form">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <button type="submit" class="btn btn--primary input-group-text update-price">@lang('تحديث')</button>
                                                    </div>
                                                </div>
                                            </form>
                                        </div>
                                        ...
                                        <form action="{{ route('admin.trip.ticket.price.update', 0) }}" class="update-form">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" name="price" id="point-{{ $loop->iteration }}" class="form-control prices-auto numeric-validation" placeholder="@lang('أدخل السعر')" min="0" required />
                                                    <button type="submit" class="btn btn--primary input-group-text update-price">@lang('تحديث')</button>
                                                </div>
                                            </div>
                                        </form>
        ...
        (function($) {
            ...
            $(document).on('submit', '.update-form', function(e) {
                ...
                if ($(this).find('[name="price"]').val() == '') {
                    notify('error', `@lang('حقل السعر مطلوب')`);
                    return false;
                }
