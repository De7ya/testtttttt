...
@section('panel')
    <div class="row mb-none-30">
        <div class="col-xl-12 col-lg-12 col-md-12 mb-30">
            <div class="card">
                <h5 class="card-header">@lang('معلومات عن سعر التذكرة') </h5>
                <div class="card-body">
                    ...
                    <form action="{{ route('admin.trip.ticket.price.store') }}" method="POST">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label> @lang('السعر من المصدر إلى الوجهة')</label>
                        ...
                        <button type="submit" class="btn btn--primary h-45 w-100 submit-button">@lang('تأكيد')</button>
                    </form>
                </div>
            </div>
        </div>
...
@push('breadcrumb-plugins')
    <a href="{{ route('admin.trip.ticket.price.index') }}" class="btn btn-sm btn-outline--primary "><i class="la la-fw la-backward"></i>@lang('العودة الى الوراء')</a>
@endpush
