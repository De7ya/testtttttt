                        ...
                        <div class="payment-method-item">
                            ...
                            <div class="payment-method-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-12">
                                        <div class="submitRequired bg--warning form-change-alert d-none mt-3"><i class="fas fa-exclamation-triangle"></i> @lang('يتعين عليك النقر فوق زر الإرسال لتطبيق التغييرات')</div>
                                        <div class="card border--primary mt-3">
                                            <div class="card-header bg--primary d-flex justify-content-between">
                                                <h5 class="text-white">@lang('بيانات المستخدم')</h5>
