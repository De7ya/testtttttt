                                ...
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="card border--primary mt-3">
                                            ...
                                            <div class="card-body">
                                                <div class="form-group">
                                                    <label>@lang('المبلغ الأدنى')</label>
                                                    <div class="input-group">
                                                ...
                                                <div class="form-group">
                                                    <label>@lang('المبلغ الأقصى')</label>
                                                    <div class="input-group">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="card border--primary mt-3">
                                            <h5 class="card-header bg--primary">@lang('شحن')</h5>
                                            <div class="card-body">
                                                <div class="form-group">
                                                ...
                                                <div class="form-group">
                                                    <label>@lang('الرسوم بالنسبة المئوية
')</label>
                                                    <div class="input-group">
                                    ...
                                    <div class="col-lg-12">
                                        <div class="card border--primary mt-3">
                                            ...
                                            <h5 class="card-header bg--primary">@lang('تعليمات الإيداع')</h5>
                                            <div class="card-body">
                                                <div class="form-group">
                                    ...
                                    <div class="col-lg-12">
                                        <div class="submitRequired bg--warning form-change-alert d-none mt-3"><i class="fas fa-exclamation-triangle"></i> @lang('يجب النقر على زر "إرسال" لتطبيق التغييرات.')</div>
                                        <div class="card border--primary mt-3">
                                            <div class="card-header bg--primary d-flex justify-content-between">
                                                <h5 class="text-white">@lang('معلومات المستخدم')</h5>
                                                <button type="button" class="btn btn-sm btn-outline-light float-end form-generate-btn"> <i class="la la-fw la-plus"></i>@lang('إضافة جديد')</button>
                                            </div>
                                            <div class="card-body">
