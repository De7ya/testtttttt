                                    ...
                                    @if (count($supportedCurrencies) > 0)
                                        <div class="input-group d-flex flex-nowrap justify-content-sm-end">
                                            <select class="newCurrencyVal ">
                                                <option value="">@lang('اختر العملة')</option>
                                                @forelse($supportedCurrencies as $currency => $symbol)
                                                    <option value="{{ $currency }}" data-symbol="{{ $symbol }}">{{ __($currency) }} </option>
                                                @empty
                                                    <option value="">@lang('لا يوجد دعم للعملة المتاحة')</option>
                                                @endforelse

                                            </select>
                                            <button type="button" class="btn btn--primary input-group-text newCurrencyBtn" data-crypto="{{ $gateway->crypto }}" data-name="{{ $gateway->name }}">@lang('إضافة جديد')</button>
                                        </div>
                                    @endif
                                </div>
                            </div>
                                ...
                                <div class="gateway-content">
                                    @if ($gateway->code < 1000 && $gateway->extra)
                                        <div class="payment-method-body mt-2">
                                            <h4 class="mb-3 payment-method-body-title">@lang('التكوينات')</h4>
                                            <div class="row">
                                                @foreach ($gateway->extra as $key => $param)
                                                    <div class="form-group col-lg-6">
                                                        ...
                                                        <div class="input-group">
                                                            ...
                                                            <button type="button" class="copyInput input-group-text" title="@lang('نسخ')"><i class="fas fa-copy"></i></button>
                                                        </div>
                                                        @if ($key == 'cron')
                                                            <small><i class="las la-info-circle"></i> @lang('حدد هذا الرابط في مهمة الجدولة (Cron) على الخادم الخاص بك للتحقق من حالة الدفع.
...
')</small>
                                    ...
                                    @endif
                                    <div class="payment-method-body mt-2">
                                        <h4 class="mb-3 payment-method-body-title">@lang('الإعداد العالمي لـ') {{ __($gateway->name) }}</h4>
                                        <div class="row">
                                        ...
                                        <div class="content">
                                            <div class="d-flex justify-content-between">
                                                ...
                                                <div class="remove-btn">
                                                    <button type="button" class="btn btn--danger confirmationBtn" data-question="@lang('هل أنت متأكد من حذف عملة البوابة هذه؟')" data-action="{{ route('admin.gateway.automatic.remove', $gatewayCurrency->id) }}">
                                                        <i class="la la-trash-o me-2"></i>@lang('ازالة')
                                                    </button>
                                                </div>
                                        ...
                                        <div class="row g-4">
                                            <div class="col-sm-12 col-md-6 col-lg-6 col-xl-4">
                                                <div class="card border--primary">
                                                    <h5 class="card-header bg--primary">@lang('المدى')</h5>
                                                    <div class="card-body">
                                                        <div class="form-group">
                                                            <label>@lang('الحد الأدنى للمبلغ')</label>
                                                            <div class="input-group">
                                                        ...
                                                        <div class="form-group">
                                                            <label>@lang('الحد الأقصى للمبلغ')</label>
                                                            <div class="input-group">
                                            ...
                                            <div class="col-sm-12 col-md-6 col-lg-6 col-xl-4">
                                                <div class="card border--primary">
                                                    <h5 class="card-header bg--primary">@lang('تكلفة')</h5>
                                                    <div class="card-body">
                                                        <div class="form-group">
                                                            <label>@lang('رسوم ثابتة')</label>
                                                            <div class="input-group">
                                            ...
                                            <div class="col-sm-12 col-md-6 col-lg-6 col-xl-4">
                                                <div class="card border--primary">
                                                    <h5 class="card-header bg--primary">@lang('عملة')</h5>
                                                    <div class="card-body">
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                            ...
                                            @if ($parameters->where('global', false)->count() != 0)
                                                ...
                                                <div class="col-lg-12">
                                                    <div class="card border--primary mt-4">
                                                        <h5 class="card-header bg--dark">@lang('إعدادات')</h5>
                                                        <div class="card-body">
                                                            <div class="row">
                        ...
                        <div class="payment-method-item child--item newMethodCurrency d-none">
                            ...
                            <div class="payment-method-header">
                                <div class="content">
                                    <div class="d-flex justify-content-between">
                                        <div class="form-group">
                                            <h4 class="mb-3" id="payment_currency_name">@lang('الاسم')</h4>
    ...
    <script>
        (function($) {
            ...
            function validateInput() {
                ...
                if (!minAmountValue) {
                    minAmountErrorMessage.text('@lang('يجب إدخال الحد الأدنى من المبلغ')');
                    maxAmountErrorMessage.empty();
                    return;
                }

                if (!maxAmountValue) {
                    maxAmountErrorMessage.text('@lang('يجب إدخال الحد الأقصى للمبلغ')');
                    minAmountErrorMessage.empty();
                    return;
                }

                if (minAmountValue >= maxAmountValue) {
                    minAmountErrorMessage.text('@lang('يجب أن يكون الحد الأدنى للمبلغ أقل من الحد الأقصى للمبلغ')');
                    maxAmountErrorMessage.empty();
                    hasError = true;
                    return;
                }
