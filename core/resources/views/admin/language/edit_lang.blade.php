...
@section('panel')
    <div id="app">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row justify-content-between mt-3">
                            <div class="col-md-7">
                                <ul>
                                    <li>
                                        <h5>@lang('الكلمات الرئيسية للغة') {{ __($lang->name) }}</h5>
                                    </li>
                                </ul>
                            </div>
                            <div class="col-md-5 mt-md-0 mt-3">
                                <button type="button" data-bs-toggle="modal" data-bs-target="#addModal" class="btn btn-sm btn-outline--primary float-end"><i class="fas fa-plus"></i> @lang('إضافة مفتاح جديد') </button>
                            </div>
                        </div>
                        <hr>
            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <div class="modal-header">
                        <h4 class="modal-title" id="addModalLabel"> @lang('إضافة جديد')</h4>
        ...
        <div class="modal fade" id="editModal" tabindex="-1" role="dialog" aria-labelledby="editModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <div class="modal-header">
                        <h4 class="modal-title" id="editModalLabel">@lang('تعديل')</h4>
        ...
        <div class="modal fade" id="DelModal" tabindex="-1" role="dialog" aria-labelledby="DelModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="DelModalLabel"> @lang('تنبيه التأكيد!')</h5>
                        <button type="button" class="close" data-bs-dismiss="modal" aria-label="Close"><i class="las la-times"></i></button>
                    </div>
                    <div class="modal-body">
    ...
    <div class="modal fade" id="importModal">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title">@lang('استيراد الكلمات الرئيسية')</h4>
                    <button type="button" class="close" data-bs-dismiss="modal" aria-label="Close"><i class="las la-times"></i></button>
                </div>
                <div class="modal-body">
                    <div class="form-group">
                        <label>@lang('الاستيراد من')</label>
                        <select class="form-control select_lang select2" data-minimum-results-for-search="-1" required>
                            ...
                            <option value="999">@lang('النظام')</option>
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn--dark" data-bs-dismiss="modal">@lang('مغلق')</button>
                    <button type="button" class="btn btn--primary import_lang"> @lang('استيراد الآن')</button>
                </div>
            </div>
        </div>
    </div>
...
@push('breadcrumb-plugins')
    ...
    <button type="button" class="btn btn-sm btn-outline--primary importBtn"><i class="la la-download"></i>@lang('استيراد الكلمات الرئيسية')</button>
@endpush
