    ...
    <div class="row">
        <div class="col-md-12 mb-30">
            <div class="card bl--5 border--primary">
                <div class="card-body">
                    <p class="text--primary">@lang('إذا كنت تريد إرسال إشعار دفع من خلال Firebase، فيجب أن يكون نظامك معتمدًا بشهادة SSL')</p>
                </div>
            </div>
        </div>
        <div class="col-md-12">
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label>@lang('مفتاح API') </label>
                                    <input type="text" class="form-control" placeholder="@lang('مفتاح API')" name="apiKey" value="{{ @gs('firebase_config')->apiKey }}" required>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label>@lang('مجال المصادقة') </label>
                                    <input type="text" class="form-control" placeholder="@lang('مجال المصادقة')" name="authDomain" value="{{ @gs('firebase_config')->authDomain }}" required>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label>@lang('معرف المشروع') </label>
                                    <input type="text" class="form-control" placeholder="@lang('')" name="projectId" value="{{ @gs('firebase_config')->projectId }}" required>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label>@lang('وحدة تخزين') </label>
