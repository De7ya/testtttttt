                                ...
                                <td>
                                    <div class="action-btns">
                                        <div class="btn-group btn-group-sm">
                                            <a href="{{ route('admin.setting.notification.template.edit', ['email',$template->id]) }}" class="btn btn-outline--primary">@lang('البريد الالكترني')</a>
...
{{--                                         <div class="btn-group btn-group-sm">
                                            <a href="{{ route('admin.setting.notification.template.edit', ['sms',$template->id]) }}"  class="btn btn-outline--info">@lang('الرسائل')</a>
 ...
 --}}                                        <div class="btn-group btn-group-sm">
                                            <a href="{{ route('admin.setting.notification.template.edit', ['push',$template->id]) }}" class="btn btn-outline--success">@lang('إضافة')</a>
