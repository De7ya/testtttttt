        ...
        <div class="container custom-container d-flex justify-content-center">
            <div class="login-area">
                <div class="text-center mb-3">
                    <h2 class="text-white mb-2">@lang('رمز التحقق')</h2>
                    <p class="text-white mb-2">@lang('يرجى التحقق من بريدك الإلكتروني وإدخال رمز التحقق الذي حصلت عليه في بريدك الإلكتروني.')</p>
                </div>
                <form action="{{ route('admin.password.verify.code') }}" method="POST" class="login-form w-100">
                    ...
                    <div class="code-box-wrapper d-flex w-100">
                        <div class="form-group mb-3 flex-fill">
                            <span class="text-white">@lang('رمز التحقق')</span>
                    ...
                    <div class="d-flex flex-wrap justify-content-between mt-3">
                        <a href="{{ route('admin.password.reset') }}" class="forget-text">@lang('حاول الإرسال مرة أخرى')</a>
                        <a href="{{ route('admin.login') }}" class="text-white"><i class="las la-sign-in-alt"></i>@lang('العودة إلى تسجيل الدخول')</a>
                    </div>
                </form>
            </div>
        </div>
