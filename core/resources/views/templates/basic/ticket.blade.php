                ...
                <form action="{{ route('search') }}" class="ticket-form ticket-form-two row g-3 justify-content-center">
                    <div class="col-md-4 col-lg-3">
                        <div class="form--group">
                            ...
                            <select name="pickup" class="form--control select2">
                                <option value="">@lang('نقطة الالتقاء')</option>
                    ...
                    <div class="col-md-4 col-lg-3">
                        <div class="form--group">
                            ...
                            <select name="destination" class="form--control select2">
                                <option value="">@lang('نقطة الإنزال')</option>
                                @foreach ($counters as $counter)
                    ...
                    <div class="col-md-4 col-lg-3">
                        <div class="form--group">
                            ...
                            <input type="text" name="date_of_journey" class="form--control date-range" placeholder="@lang('تاريخ الرحلة')" autocomplete="off" value="{{ request()->date_of_journey }}">
                        </div>
                    </div>
                    <div class="col-md-6 col-lg-3">
                        <div class="form--group">
                            <button class="btn btn--base w-100">@lang('البحث عن التذاكر')</button>
                        </div>
                    </div>
                </form>
            </div>
    ...
    <section class="ticket-section padding-bottom section-bg">
        <div class="container">
            <div class="row gy-5">
                    ...
                    <form action="{{ route('search') }}" id="filterForm">
                        <div class="ticket-filter">
                            <div class="filter-header filter-item">
                                <h4 class="title mb-0">@lang('فلتر')</h4>
                                <button type="reset" class="reset-button h-auto">@lang('إعادة تعيين الكل ')</button>
                            </div>
                            @if ($fleetType)
                                <div class="filter-item">
                                    <h5 class="title">@lang('نوع المركبة')</h5>
                                    <ul class="bus-type">
                ...
                @if ($schedules)
                    <div class="filter-item">
                        <h5 class="title">@lang('الجداول الزمنية')</h5>
                        <ul class="bus-type">
                    ...
                    @if ($ticket)
                        <div class="ticket-item">
                            <div class="ticket-item-inner">
                                ...
                                <span class="bus-info">@lang('تخطيط المقعد - ') {{ __($trip->fleetType->seat_layout) }}</span>
                            ...
                            <div class="ticket-item-inner book-ticket">
                                ...
                                @if ($trip->day_off)
                                    <div class="seats-left mt-2 mb-3 fs--14px">
                                        @lang('أيام العطلة'): <div class="d-inline-flex flex-wrap" style="gap:5px">
                            ...
                            <a class="btn btn--base" href="{{ route('ticket.seats', [$trip->id, slug($trip->title)]) }}">@lang('اختر المقعد')</a>
                        </div>
                        @if ($trip->fleetType->facilities)
                            <div class="ticket-item-footer">
                                <div class="d-flex content-justify-center">
                                    <span>
                                        <strong>@lang('مرافق - ')</strong>
