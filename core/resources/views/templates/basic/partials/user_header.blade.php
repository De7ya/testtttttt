    ...
    <div class="container">
        <div class="header-bottom-area">
            ...
            <ul class="menu">
                ...
                <li>
                    <a href="javascript:void(0)">@lang('الحجز')</a>
                    <ul class="sub-menu">
                        <li>
                            <a href="{{ route('ticket') }}">@lang('شراء تذكرة')</a>
                        </li>
                        <li>
                            <a href="{{ route('user.ticket.history') }}">@lang('سجل الحجز')</a>
                        </li>
                    </ul>
                </li>
                <li>
                    <a href="javascript:void(0)">@lang('تذكرة الدعم')</a>
                    <ul class="sub-menu">
                        <li>
                            <a href="{{ route('ticket.open') }}">@lang('إنشاء جديد')</a>
                        </li>
                        <li>
                            <a href="{{ route('ticket.index') }}">@lang('تذاكر')</a>
                        </li>
                    </ul>
                </li>
                <li>
                    <a href="#0">@lang('الحساب')</a>
                    <ul class="sub-menu">
                        <li>
                            <a href="{{ route('user.profile.setting') }}">@lang('الحساب')</a>
                        </li>
                        <li>
                            <a href="{{ route('user.change.password') }}">@lang('تغيير كلمة المرور')</a>
                        </li>
                        <li>
                            <a href="{{ route('user.logout') }}">@lang('تسجيل خروج')</a>
                        </li>
                    </ul>
                </li>
            </ul>
            <div class="d-flex flex-wrap align-items-center">
                <a href="{{ route('ticket') }}" class="cmn--btn btn--sm">@lang('شراء تذاكر')</a>
