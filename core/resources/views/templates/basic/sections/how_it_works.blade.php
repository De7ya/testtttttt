        ...
        <div class="row justify-content-center" style="direction: rtl">
            <div class="col-lg-6 col-md-10">
                <div class="section-header text-center">
                    <h2 class="title" style="font-family:'Tajawal', system-ui, -apple-system, 'Segoe UI', Roboto, 'Helvetica Neue', Arial, 'Noto Sans', 'Apple Color Emoji','Segoe UI Emoji','Segoe UI Symbol' !important;">
  احصل على تذكرتك بثلاث خطوات فقط
</h2>
        ...
        <div class="row g-4 gy-md-5 justify-content-center" style="direction: rtl">
