...
@section('content')
    <div class="container padding-top padding-bottom rtl">
                ...
                <form action="{{ route('user.deposit.insert') }}" method="post" class="deposit-form">
                    ...
                    <div class="gateway-card">
                        <div class="row justify-content-center gy-sm-4 gy-3">
                            <div class="col-12">
                                <h5 class="payment-card-title">@lang('الدفع')</h5>
                            </div>
                            <div class="col-lg-6">
 ...
 --}}                                            <input class="payment-item__radio gateway-input"
                                    ...
                                    @if ($gatewayCurrency->count() > 4)
                                        <button type="button" class="payment-item__btn more-gateway-option">
                                            <p class="payment-item__btn-text">@lang('عرض جميع خيارات الدفع')</p>
                                ...
                                <div class="payment-system-list p-3">
                                    <div class="deposit-info">
                                        <div class="deposit-info__title">
                                            <p class="text mb-0">@lang('السعر')</p>
                                        </div>
...
{{--                                     <hr>
 --}}{{--                                     <div class="deposit-info">
                                        <div class="deposit-info__title">
                                            <p class="text has-icon"> @lang('الحد')
                                                <span></span>
                                            </p>
                                        </div>
                                        <div class="deposit-info__input">
 ...
 --}}                                    {{-- <div class="deposit-info">
                                        <div class="deposit-info__title">
                                            <p class="text has-icon">@lang('رسوم المعالجة')
                                                <span data-bs-toggle="tooltip" title="@lang('رسوم المعالجة لبوابات الدفع')"
...
{{--                                     <div class="deposit-info gateway-conversion d-none total-amount pt-2">
 ...
 --}}                                    <div class="deposit-info conversion-currency d-none total-amount pt-2">
                                        <div class="deposit-info__title">
                                            <p class="text">
                                                @lang('') <span class="gateway-currency"></span>
                                            </p>
                                        </div>
                                        <div class="deposit-info__input">
                                            <p class="text">
                                    ...
                                    <div class="d-none crypto-message mb-3">
                                        @lang('التحويل باستخدام') <span class="gateway-currency"></span> @lang('والقيمة النهائية ستظهر في الخطوة التالية')
                                    </div>
                                    <button type="submit" class="btn btn--base w-100" disabled>
                                        @lang('تأكيد الدفع')
                                    </button>
                                    <div class="info-text pt-3">
                                        <p class="text">@lang('نتمنى لك رحلة ممتعة')</p>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <div class="modal-content rtl">
                ...
                <form action="{{ route('user.deposit.insert') }}" method="post">
                    ...
                    <div class="modal-body">
                        ...
                        <span>@lang('هل أنت متأكد أنك تريد الدفع عبر …؟') <strong class="method-name font-weight-bold"></strong> ؟</span>
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn--danger w-auto btn--sm"
                                data-bs-dismiss="modal">@lang('إغلاق')</button>
                        <div class="prevent-double-click">
                            <button type="submit"
                                    class="btn btn--success confirm-btn btn--sm">@lang('تأكيد')</button>
                        </div>
                    </div>
                </form>
            </div>
...
@push('style')
    <style>
        ...
        .rtl .text, .rtl p, .rtl h1, .rtl h2, .rtl h3, .rtl h4, .rtl h5, .rtl h6 { text-align: right; }
        .rtl .payment-item__info { text-align: right; }
        .rtl .payment-item__name { display: inline-block; }
        /* Keep input-group visual order intact */
        .rtl .deposit-info__input-group { direction: ltr; }

        /* Optional: align modal text/buttons to RTL while keeping close button aligned properly */
        .rtl .modal-title, .rtl .modal-body, .rtl .modal-footer { text-align: right; }
        ...
        (function($) {
            ...
            function gatewayChange() {
                ...
                if (gateway) {
                    ...
                    minAmount = 0;
                    maxAmount = 0;
                    $(".proccessing-fee-info").attr("data-bs-original-title", "N/A");
                }
                calculation();
            }
